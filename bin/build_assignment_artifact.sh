...
cp /tmp/sshegheva3/analysis/README.md /tmp/sshegheva3/README.md
cp "/tmp/sshegheva3/analysis/notebooks/Supervised Classification.pdf" "/tmp/sshegheva3/sshegheva3-analysis.pdf"
